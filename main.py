...
while cap.isOpened():
    ...
    _, otsu = cv2.threshold(gray, 180, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)
    ...
    #TODO: try using cv2.boundingRect to bound away from the edges of the camera (since its detecting the edge as the largest object)
